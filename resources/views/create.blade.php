...
<body class="bg-gradient-to-br from-slate-50 via-amber-50 to-slate-100 min-h-screen">
  ...
  <div class="bg-white border-b border-gray-200">
    <div class="container mx-auto px-6 py-3">
      <div class="flex items-center space-x-2 text-sm">
        ...
        <span class="text-amber-700 hover:text-amber-800 font-medium">Liste des employés</span>
      </div>
    </div>
  </div>
  ...
  <div class="max-w-3xl mx-auto px-6 py-8">
      ...
      <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-emerald-50 to-teal-50 px-8 py-6 border-b border-emerald-100">
          <div class="flex items-center space-x-4">
            ...
            <div>
              <h2 class="text-3xl font-extrabold text-black bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600">Ajouter un nouvel employé</h2>
              <p class="text-gray-600 text-lg mt-1">Remplissez les informations du nouveau collaborateur</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="bg-white rounded-2xl shadow-2xl border border-gray-200">
      <form action="{{ route('employees.store') }}" method="POST" class="p-8 space-y-6">
        ...
        <div class="space-y-2">
          ...
          <input type="text" name="first_name" value="{{ old('first_name') }}" placeholder="Entrez le prénom" required
            class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-emerald-500 focus:ring-4 focus:ring-emerald-200 transition-all duration-200 text-gray-800 font-medium" />
          @error('first_name')
        ...
        <div class="space-y-2">
          ...
          <input type="text" name="last_name" value="{{ old('last_name') }}" placeholder="Entrez le nom" required
            class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-emerald-500 focus:ring-4 focus:ring-emerald-200 transition-all duration-200 text-gray-800 font-medium" />
          @error('last_name')
          <div class="flex items-center space-x-2 text-red-600 text-sm font-semibold bg-red-50 px-3 py-2 rounded-lg">
            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="space-y-2">
          ...
          <input type="text" name="position" value="{{ old('position') }}" placeholder="Ex: Développeur, Manager, etc."
            class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-emerald-500 focus:ring-4 focus:ring-emerald-200 transition-all duration-200 text-gray-800 font-medium" />
          @error('position')
          <div class="flex items-center space-x-2 text-red-600 text-sm font-semibold bg-red-50 px-3 py-2 rounded-lg">
            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="mt-6 bg-emerald-50 border-l-4 border-emerald-500 rounded-lg p-4 shadow-md">
      <div class="flex items-start space-x-3">
        ...
        <div>
          <h3 class="font-bold text-emerald-900 mb-1">Information importante</h3>
          <p class="text-emerald-800 text-sm">Tous les champs marqués sont obligatoires. Assurez-vous que l'adresse email est valide et unique dans le système.</p>
        </div>
      </div>
    </div>
